...
const credentials = {
  ...
  redirect_uris: [
    "https://iceyisaak.github.io/meet/"
  ],
  javascript_origins: [
    "https://iceyisaak.github.io",
    "http://localhost:3000"
  ],
};
...
// getAccessToken()
// Step 2: Use code from the 1st Step to generate access token
module.exports.getAccessToken = async (event) => {

  // The values for instantiating the oAuthClient
  const oAuth2Client = new google.auth.OAuth2(
    client_id,
    client_secret,
    redirect_uris[0]
  ...
  return new Promise(
    (resolve, reject) => {
      ...
      // Exchange authorisation code with a 'callback' after the exchange
